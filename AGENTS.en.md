...
The Star History chart is generated by this repository's GitHub Actions using a short-lived <code>GITHUB_TOKEN</code>. Never put a personal access token in a README, SVG, or repository configuration.
